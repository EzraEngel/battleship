...
Game::Game(ASCII text_var, Board board_p, Board board_c, Player player_p, Player player_c) {
...
string Game::to_upper(string lower_string) {
  string upper_string = "";
...
void Game::strike_feedback(char strike_code) {
  if (strike_code == ' ') {
  	text_gen.miss();
  }
